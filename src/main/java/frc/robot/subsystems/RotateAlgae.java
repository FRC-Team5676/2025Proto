...
public class RotateAlgae extends SubsystemBase {
  ...
  private final double maxRotations = Units.degreesToRadians(-30);

  public RotateAlgae() {
    // Drive Motor setup
    m_driveMotor = new SparkMax(m_RotateAlgaeCanId, MotorType.kBrushless);
