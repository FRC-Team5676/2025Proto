...
public class MoveLinearArmCommand extends Command {

    private final LinearArmSubsystem m_controlArm;
    private final CommandXboxController m_controller;

    /** Driver control */
    public MoveLinearArmCommand(LinearArmSubsystem controlArm, CommandXboxController controller) {
